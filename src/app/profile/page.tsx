        ...
        <Layout>
            <div className="max-w-6xl mx-auto p-6">
                ...
                <div className="bg-white rounded-3xl p-8 mb-8 shadow-lg">
                            ...
                            {isEditing ? (
                                <div className="space-y-3">
                                    <input
                                        ...
                                        className="text-3xl font-title bg-white/80 border border-gray-300 rounded-xl px-4 py-2 text-gray-800 placeholder-gray-500 focus:outline-none focus:bg-white focus:ring-2 focus:ring-blue-300 transition-colors"
                                    ...
                                    <input
                                        ...
                                        className="text-xl bg-white/80 border border-gray-300 rounded-xl px-4 py-2 text-gray-800 placeholder-gray-500 focus:outline-none focus:bg-white focus:ring-2 focus:ring-blue-300 transition-colors font-body"
                            ...
                            {isEditing ? (
                                <>
                                    ...
                                    <button
                                        ...
                                        className="bg-gray-500 hover:bg-gray-600 text-white font-body-bold px-6 py-3 rounded-2xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
                                    >
                                        Cancel
                                    </button>
                                </>
                                ...
                                <button
                                    onClick={handleEdit}
                                    className="bg-white hover:bg-gray-50 text-gray-800 font-body-bold px-6 py-3 rounded-2xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 border border-gray-300"
                                >
                                    Edit Profile
                                </button>
                            )}
                    ...
                    {/* Stats */}
                    <div className="mt-8">
                        <h3 className="text-xl font-title text-gray-800 mb-6">Your Stats</h3>
                        <div className="grid grid-cols-4 gap-4">
                            <div className="bg-gray-50 rounded-xl p-4 text-center">
                                <p className="text-2xl font-title text-gray-800">{profileData.stats?.posts || 0}</p>
                                <p className="text-sm text-gray-600 font-body">Posts Created</p>
                            </div>
                            <div className="bg-gray-50 rounded-xl p-4 text-center">
                                <p className="text-2xl font-title text-gray-800">{profileData.stats?.likes || 0}</p>
                                <p className="text-sm text-gray-600 font-body">Likes Given</p>
                            </div>
                            <div className="bg-gray-50 rounded-xl p-4 text-center">
                                <p className="text-2xl font-title text-gray-800">{profileData.stats?.comments || 0}</p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-8">
                        {/* Account Information */}
                        <div>
                            <h3 className="text-xl font-title text-gray-800 mb-6">Account Information</h3>
                            <div className="space-y-6">
                                <div>
                                    ...
                                    {isEditing ? (
                                        ...
                                        <p className="text-gray-800 text-lg font-body">{profileData.email}</p>
                                    )}
                                </div>
                                <div>
                                    ...
                                    {isEditing ? (
                                        ...
                                        <p className="text-gray-800 text-lg font-body">••••••••</p>
                                    )}
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="space-y-8">
                        {/* Social Links */}
                        <div>
                            <h3 className="text-xl font-title text-gray-800 mb-6">Social Links</h3>
                            <div className="space-y-6">
                                <div>
                                    ...
                                    {isEditing ? (
                                        ...
                                        <p className="text-gray-800 text-lg font-body">{profileData.socialLinks.twitter}</p>
                                    )}
                                </div>
                                <div>
                                    <label className="block text-sm font-body-bold text-gray-700 mb-3 flex items-center space-x-2">
                                    ...
                                    {isEditing ? (
                                        ...
                                        <p className="text-gray-800 text-lg font-body">{profileData.socialLinks.instagram}</p>
                                    )}
                                </div>
                                <div>
                                    <label className="block text-sm font-body-bold text-gray-700 mb-3 flex items-center space-x-2">
                                    ...
                                    {isEditing ? (
                                        ...
                                        <p className="text-gray-800 text-lg font-body">{profileData.socialLinks.github}</p>
                                    )}
                                </div>
                                <div>
                                    <label className="block text-sm font-body-bold text-gray-700 mb-3 flex items-center space-x-2">
                                    ...
                                    {isEditing ? (
                                        ...
                                        <p className="text-gray-800 text-lg font-body">{profileData.socialLinks.website}</p>
                                    )}
                                </div>
                            </div>
                        </div>
                ...
                {/* Bio - Full Width */}
                <div className="mt-8">
                    <h3 className="text-xl font-title text-gray-800 mb-6">Bio</h3>
                    {isEditing ? (
                        <textarea
                            value={editData.bio}
                        ...
                        <p className="text-gray-800 text-lg leading-relaxed font-body">{profileData.bio}</p>
                    )}
                </div>
            </div>
        </Layout>
